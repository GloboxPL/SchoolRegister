...
namespace SchoolRegister.Migrations
{
    ...
    [Migration("20210426053315_AddAttendancesAndMarks")]
    partial class AddAttendancesAndMarks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolRegister.Models.Attendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SchoolRegister.Models.Mark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SchoolRegister.Models.Attendance", b =>
                {
                    b.HasOne("SchoolRegister.Models.Lesson", "Lesson")
                        .WithMany()
                        .HasForeignKey("LessonId");

                    b.HasOne("SchoolRegister.Models.Student", "Students")
                        .WithMany()
                        .HasForeignKey("StudentsId");
